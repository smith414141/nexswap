...
const WEB3_DAPPS = [
  ...
  { name: "OpenSea", icon: "🏛️", desc: "Largest NFT marketplace", cat: "nft", chain: "multi", tvl: "$1.5B" },
  { name: "Blur", icon: "🌫️", desc: "Pro NFT trading & lending", cat: "nft", chain: "ethereum", tvl: "$0.8B" },
  ...
  { name: "Magic Eden", icon: "✨", desc: "Cross-chain NFT marketplace", cat: "nft", chain: "multi", tvl: "$0.9B" },
